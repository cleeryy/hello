...
func TestEmbeddedSpec(t *testing.T) {
	...
	for _, s := range []string{"Device", "Problem", "ValidationProblem", "StatusChange", "WakeEvent", "WakeHistory", "Schedule", "ScheduleInput", "ScheduleList", "Host", "DiscoverResult", "AdoptInput"} {
